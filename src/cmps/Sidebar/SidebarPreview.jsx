...
export function SidebarPreview({ 
  ...
  const subtitle = playlist.createdById === userId
    ? userFirstName
    ...
    >
      ...
      <div className="details">
        ...
        <p>
          ...
          {/* <span className="songs">{`Playlist • ${playlist.songCount} ${playlist.songCount === 1 ? 'song' : 'songs'}`}</span> */}
          <span className="songs">Playlist • {subtitle}</span>
        </p>
      </div>
    </li>
  )
