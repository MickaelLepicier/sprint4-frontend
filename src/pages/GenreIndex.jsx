...
const genres = [
    ...
    { name: 'Wellness', color: 'rgb(161, 208, 156)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/wellness_wbwubx.jpg' },
    { name: 'Anime', color: 'rgb(13, 115, 236)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/anime_g3xn3c.jpg' },
    { name: 'Gaming', color: 'rgb(246, 163, 191)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/gaming_dkfbye.jpg' },
    { name: 'Folk & Acoustic', color: 'rgb(238, 214, 192)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/folk-and-acoustic_z8rcgl.jpg' },
    ...
    { name: 'Ambient', color: 'rgb(18, 18, 18)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/ambient-essentials_ubnyb6.jpg' },
    { name: 'Netflix', color: 'rgb(18, 18, 18)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/netflix_iewjrb.jpg' },
    { name: 'Blues', color: 'rgb(18, 18, 18)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/blues_awqd7m.jpg' },
    { name: 'Cooking & Dining', color: 'rgb(18, 18, 18)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/cooking-and-dining_ughhhh.jpg' },
    { name: 'Alternative', color: 'rgb(18, 18, 18)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/alternative_v7ocef.jpg' },
    { name: 'Travel', color: 'rgb(18, 18, 18)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/travel_fyubs6.jpg' },
    { name: 'Caribbean', color: 'rgb(20, 138, 8)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/caribbean_cxtkvg.jpg' },
    { name: 'Afro', color: 'rgb(230, 30, 50)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/afro_q3l69d.jpg' },
    { name: 'GLOW', color: 'rgb(13, 115, 236)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/glow_bptnxm.jpg' },
    { name: 'Songwriters', color: 'rgb(186, 93, 7)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/songwriters_w4r3j0.jpg' },
    { name: 'Nature & Noise', color: 'rgb(225, 51, 0)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/nature-and-noise_pu9erk.jpg' },
    { name: 'Funk & Disco', color: 'rgb(13, 114, 237)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/funk-and-disco_bln5zd.jpg' },
    { name: 'Spotify Singles', color: 'rgb(13, 115, 236)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/spotify-singles_arbb0v.jpg' },
    { name: 'Summer', color: 'rgb(140, 25, 50)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/summer_gmfqr3.jpg' },
    { name: 'EQUAL', color: 'rgb(13, 115, 236)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/equal_lms84d.jpg' },
    { name: 'RADAR', color: 'rgb(140, 25, 50)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/radar_ss10lf.jpg' },
    { name: 'Fresh Finds', color: 'rgb(71, 125, 149)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/fresh-finds_toimcg.jpg' },
    { name: 'Tastemakers', color: 'rgb(175, 40, 150)', imgUrl: 'https://res.cloudinary.com/dkxnyqrkc/image/upload/v1748422332/tastemakers_kxhbj0.png' }
]
