...
export function SidebarList({ stations }) {
  return (
    <section className="sidebar-list">
      <ul>
        <li className="liked-songs-row" draggable="true">
          <div className="img-wrapper">
            <img src="https://misc.scdn.co/liked-songs/liked-songs-64.png" alt="Liked Songs" draggable="false" />
